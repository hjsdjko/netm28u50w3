<template>
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="销售单号" prop="xiaoshoudanhao">
					<el-input v-model="ruleForm.xiaoshoudanhao" placeholder="销售单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xiaoshoudanhao" label="销售单号" prop="xiaoshoudanhao">
					<el-input v-model="ruleForm.xiaoshoudanhao" placeholder="销售单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="销售时间" prop="xiaoshoushijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.xiaoshoushijian" 
						type="datetime"
						:readonly="ro.xiaoshoushijian"
						placeholder="销售时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xiaoshoushijian" label="销售时间" prop="xiaoshoushijian">
					<el-input v-model="ruleForm.xiaoshoushijian" placeholder="销售时间" readonly></el-input>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.xiaoshoushijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xiaoshoushijian'){
							this.ruleForm.xiaoshoushijian = obj[o];
							this.ro.xiaoshoushijian = true;
							continue;
						}
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.xiaoshoudanhao) {
			this.ruleForm.xiaoshoudanhao = String(this.ruleForm.xiaoshoudanhao)
		}
