<template>
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="退货单号" prop="tuihuodanhao">
					<el-input v-model="ruleForm.tuihuodanhao" placeholder="退货单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.tuihuodanhao" label="退货单号" prop="tuihuodanhao">
					<el-input v-model="ruleForm.tuihuodanhao" placeholder="退货单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商品类别" prop="shangpinleibie">
					<el-input v-model="ruleForm.shangpinleibie" placeholder="商品类别" clearable  :readonly="ro.shangpinleibie"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="商品类别" prop="shangpinleibie">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="退货金额" prop="tuihuojine">
					<el-input v-model="tuihuojine" placeholder="退货金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.tuihuojine" label="退货金额" prop="tuihuojine">
					<el-input v-model="ruleForm.tuihuojine" placeholder="退货金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="退货日期" prop="tuihuoriqi">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.tuihuoriqi" label="退货日期" prop="tuihuoriqi">
...
export default {
	...
	created() {
		this.ruleForm.tuihuoriqi = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='tuihuodanhao'){
							this.ruleForm.tuihuodanhao = obj[o];
							this.ro.tuihuodanhao = true;
							continue;
						}
						...
						if(o=='tuihuojine'){
							this.ruleForm.tuihuojine = obj[o];
							this.ro.tuihuojine = true;
							continue;
						}
						if(o=='tuihuoriqi'){
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.tuihuodanhao) {
			this.ruleForm.tuihuodanhao = String(this.ruleForm.tuihuodanhao)
		}
        this.ruleForm.tuihuojine = this.tuihuojine
