	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="营业执照号码" prop="yingyezhizhaohaoma">
					<el-input v-model="ruleForm.yingyezhizhaohaoma" placeholder="营业执照号码" clearable  :readonly="ro.yingyezhizhaohaoma"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="营业执照号码" prop="yingyezhizhaohaoma">
					<el-input v-model="ruleForm.yingyezhizhaohaoma" placeholder="营业执照号码" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='yingyezhizhaohaoma'){
							this.ruleForm.yingyezhizhaohaoma = obj[o];
							this.ro.yingyezhizhaohaoma = true;
							continue;
						}
				}
			}
